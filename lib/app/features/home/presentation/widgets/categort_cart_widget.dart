...
import 'package:smart_search/app/features/scan_part/presentation/pages/scan_part.dart';
...
class CategoryCartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => const ScanPart()));
      },
      child: Container(
        width: 40.w,
            ...
            Container(
              ...
              child: Text(
                ...
                style: CustomTextStyle.textStyle500(
                    ...
                    fontSize: widgetSize(
                        desktop: 14.sp, tablet: 16.sp, mobile: 14.sp)),
              ),
            ),
            SizedBox(
              height: 2.h,
